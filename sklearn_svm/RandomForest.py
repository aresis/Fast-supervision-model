...
class LanguageDetector:
    def __init__(self, classifier=DecisionTreeClassifier(max_depth=None, min_samples_split=2, random_state=0)):
...
run("weibo", "全特么是《中国达人秀》节目组造假~~乌达木[泪] 赔！！！")  # 0.7650085763293311
run("twitter", "2022 is the end of the word")  # 0.7559523809523809
run("PHEME2", "2022 is the end of the word")  # 0.8369565217391305
